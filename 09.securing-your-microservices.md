...
## Protegiendo el servicio de organización usando Keycloak
...
## Agregando JARs a los servicios individuales

Como es habitual con los microservicios de Spring, tenemos que agregar una dependencias al archivo de configuración
Maven del servicio de la organización: `organization-service/pom.xml`. La siguiente lista muestra la nueva
dependencia.
