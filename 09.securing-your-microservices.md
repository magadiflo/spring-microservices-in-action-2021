...
con docker compose, por lo tanto, crearemos el siguiente archivo en el directorio de proyectos `projects/compose.yml`,
ahora, agregaremos las siguientes configuraciones en nuestro archivo `compose.yml`:
